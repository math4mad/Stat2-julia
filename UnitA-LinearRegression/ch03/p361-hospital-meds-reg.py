...
def _(data, dataset_name, eda, message, mo):
    if data is None:
        _output = mo.vstack([mo.md("# UnitA-LinearRegression/ch03/p361-hospital-meds-reg.jl\n\n**Migration:** ANOVA."), mo.md(message)])
    else:
...
@app.cell
def _(data, mo):
    model_formula = 'sqrtMDs~Hospitals+Beds+Hospitals*Beds'
