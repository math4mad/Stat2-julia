...
def _(data, dataset_name, eda, message, mo):
    if data is None:
        _output = mo.vstack([mo.md("# UnitA-LinearRegression/ch03/p357-houseNY-detecting-multicollinearity.jl\n\n**Migration:** ANOVA."), mo.md(message)])
    else:
...
@app.cell
def _(data, mo):
    model_formula = 'Price~Baths+Beds+Size+Lot'
