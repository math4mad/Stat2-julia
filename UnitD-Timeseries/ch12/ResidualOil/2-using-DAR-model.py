...
def _(Path, eda_table, load_rda, mo):
    dataset_name = 'ResidualOil'
    data_dir = Path(__file__).resolve().parents[3] / "Stat2Data"
...
def _(data, dataset_name, eda, message, mo):
    if data is None:
        _output = mo.vstack([mo.md("# UnitD-Timeseries/ch12/ResidualOil/2-using-DAR-model.jl\n\n**Migration:** time series / ARIMA."), mo.md(message)])
    else:
