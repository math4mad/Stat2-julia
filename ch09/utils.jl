...
"""
    plot_dot_boxplot(gdf::GroupedDataFrame,cats,colors::Vector{Symbol},feature::String)
    绘制 分组 df  dotplot, boxplot

 ## Arguments
 1. gdf:GroupedDataFrame
 2. 分组名: eg `cats=["Beef","Cereal","Pork"]`

 3. 每组颜色: eg `colors=[:purple,:blue,:red]`

 4. feature , ys's feature

"""
function plot_dot_boxplot(gdf::GroupedDataFrame,cats,colors::Vector{Symbol},feature::String)
     len=length(cats)
