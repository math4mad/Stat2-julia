---
title: "Utils"
description: "Browser view of the utils.py marimo note."
---

[Open the Python source](utils.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/utils.py)
