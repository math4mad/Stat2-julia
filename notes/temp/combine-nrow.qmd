---
title: "Combine Nrow"
description: "Browser view of the temp/combine-nrow.py marimo note."
---

[Open the Python source](../temp/combine-nrow.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/temp/combine-nrow.py)
