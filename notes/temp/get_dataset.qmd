---
title: "Get Dataset"
description: "Browser view of the temp/get_dataset.py marimo note."
---

[Open the Python source](../temp/get_dataset.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/temp/get_dataset.py)
