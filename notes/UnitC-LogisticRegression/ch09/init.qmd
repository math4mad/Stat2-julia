---
title: "Init"
description: "Browser view of the UnitC-LogisticRegression/ch09/init.py marimo note."
---

[Open the Python source](../../UnitC-LogisticRegression/ch09/init.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitC-LogisticRegression/ch09/init.py)
