---
title: "Parse Toml"
description: "Browser view of the parse-toml.py marimo note."
---

[Open the Python source](parse-toml.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/parse-toml.py)
