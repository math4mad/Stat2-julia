---
title: "Long To Wide Table"
description: "Browser view of the UnitB-Anova/ch06/long-to-wide-table.py marimo note."
---

[Open the Python source](../../UnitB-Anova/ch06/long-to-wide-table.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitB-Anova/ch06/long-to-wide-table.py)
