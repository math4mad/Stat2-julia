---
title: "Init"
description: "Browser view of the UnitB-Anova/ch08/init.py marimo note."
---

[Open the Python source](../../UnitB-Anova/ch08/init.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitB-Anova/ch08/init.py)
