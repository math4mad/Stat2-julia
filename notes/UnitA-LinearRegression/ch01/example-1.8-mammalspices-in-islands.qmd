---
title: "Example 1.8 Mammalspices In Islands"
description: "Browser view of the UnitA-LinearRegression/ch01/example-1.8-mammalspices-in-islands.py marimo note."
---

[Open the Python source](../../UnitA-LinearRegression/ch01/example-1.8-mammalspices-in-islands.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitA-LinearRegression/ch01/example-1.8-mammalspices-in-islands.py)
