---
title: "Example 1.7 Doctors Hospital Reg With Sqrt Transform"
description: "Browser view of the UnitA-LinearRegression/ch01/example-1.7-doctors-hospital-reg-with-sqrt-transform.py marimo note."
---

[Open the Python source](../../UnitA-LinearRegression/ch01/example-1.7-doctors-hospital-reg-with-sqrt-transform.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitA-LinearRegression/ch01/example-1.7-doctors-hospital-reg-with-sqrt-transform.py)
