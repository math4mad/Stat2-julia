---
title: "Studentized Longjump"
description: "Browser view of the UnitA-LinearRegression/ch01/studentized-longjump.py marimo note."
---

[Open the Python source](../../UnitA-LinearRegression/ch01/studentized-longjump.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitA-LinearRegression/ch01/studentized-longjump.py)
