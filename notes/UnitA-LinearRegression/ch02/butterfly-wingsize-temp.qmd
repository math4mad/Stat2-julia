---
title: "Butterfly Wingsize Temp"
description: "Browser view of the UnitA-LinearRegression/ch02/butterfly-wingsize-temp.py marimo note."
---

[Open the Python source](../../UnitA-LinearRegression/ch02/butterfly-wingsize-temp.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitA-LinearRegression/ch02/butterfly-wingsize-temp.py)
