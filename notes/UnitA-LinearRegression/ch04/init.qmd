---
title: "Init"
description: "Browser view of the UnitA-LinearRegression/ch04/init.py marimo note."
---

[Open the Python source](../../UnitA-LinearRegression/ch04/init.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitA-LinearRegression/ch04/init.py)
