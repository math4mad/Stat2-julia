---
title: "Init"
description: "Browser view of the UnitD-Timeseries/ch12/init.py marimo note."
---

[Open the Python source](../../UnitD-Timeseries/ch12/init.py) · [View on GitHub](https://github.com/math4mad/Stat2-julia/blob/gh-pages/UnitD-Timeseries/ch12/init.py)
